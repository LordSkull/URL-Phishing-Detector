...
# - cmap: prendo la colormap dal dizionario MODEL_CMAPS, così Decision Tree
#   userà sempre 'Greens' senza scriverlo a mano qui
...
save_figure(fig, 'confusion_matrix_decision_tree')
...
# Importanza di ogni feature durante il training.
importances = pd.Series(model.feature_importances_, index=X.columns)
 
# Ordino in modo CRESCENTE e prendo le ultime 10 feature più importanti.
...
plt.tight_layout()
save_figure(fig, 'feature_importance_decision_tree')
plt.show()
 
#Stampo in console la top 10 in ordine DECRESCENTE
# Round a 4 decimali per evitare numeri lunghissimi.
